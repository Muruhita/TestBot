...
export default function PromotionForm() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      setUser(meData.user);
      // Автоматически подставляем ник, если он есть в профиле
        ...
        <div className="form-container">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <textarea required value={formData.reportLink} onChange={(e) => setFormData({...formData, reportLink: e.target.value})} rows="4" />
            </div>
            <div className="form-group">
